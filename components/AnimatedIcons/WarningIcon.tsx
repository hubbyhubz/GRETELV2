...
interface WarningIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
  isHovered?: boolean;
}

const WarningIcon = forwardRef<HTMLDivElement, WarningIconProps>(
    ...
    return (
      ...
      >
        <motion.svg
          ...
          variants={{
            normal: { scale: 1 },
            animate: { scale: 1 } // Handled by parent
          }}
          viewBox="0 0 256 256"
          width={size}
