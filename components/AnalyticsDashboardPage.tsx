  ...
  return (
    <div className="flex-1 p-4 sm:p-6 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-primary-600">Analytics Dashboard</h1>
        ...
        <div className="mt-6 sm:mt-8 bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-sm sm:shadow p-4 sm:p-6 border border-gray-200 dark:border-gray-700 h-96 flex flex-col items-center justify-center text-center">
          <div className="relative flex items-center justify-center">
            <div className="absolute h-16 w-16 rounded-full border-4 border-gray-200 dark:border-gray-700 border-t-primary-600 animate-spin" />
            <AppIcon name="bulldozer" className="h-8 w-8 text-primary-600" />
          </div>
